...
{
    public class CreateVideoRequestValidator
        : AbstractValidator<CreateVideoRequest>
    {
        public CreateVideoRequestValidator()
        {
            ...
            // UPLOADED MP4
            // =========================================
            // When SourceType = UploadedFile:
            // - VideoPath is required
            // - VideoUrl must be empty
            // =========================================
            ...
            // YOUTUBE VIDEO
            // =========================================
            // When SourceType = YouTube:
            // - VideoUrl is required
            // - VideoPath must be empty
            // =========================================
            ...
            // =========================================
            // CUSTOM THUMBNAIL BUSINESS RULE
            // =========================================
